...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { desc: @deal.desc, discount_price: @deal.discount_price, price: @deal.price, quantity: @deal.quantity, title: @deal.title } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { desc: @deal.desc, discount_price: @deal.discount_price, price: @deal.price, quantity: @deal.quantity, title: @deal.title } }
